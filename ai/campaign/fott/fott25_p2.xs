...
vector gEntranceMiddle = vector(241.0, 6.0, 194.0);    // By Eirik's center gate. Used as a starting point for launching attacks.
vector gBaseCenter = vector(268.0, 1.0, 198.0);     // The center of Eirik's base. Used as the center of the Flag search radius.
string gArmyNameGuards = "Eirik Guards";  // The Army name of the units assigned to guard the Clan Leader.
