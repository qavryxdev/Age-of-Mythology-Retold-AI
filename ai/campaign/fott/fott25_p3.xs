...
/* fott25_p3.xs
   ...
   Green Norse player owning a compact base in the east of the map. They have a mixed force of Norse units,
...
vector gEntranceMiddle = vector(206.0, 6.0, 71.0);    // By Arngrim's center gate tower. Used as a starting point for launching attacks.
vector gBaseCenter = vector(213.0, 1.0, 52.0);     // The center of Arngrim's base. Used as the center of the Flag search radius.
string gArmyNameGuards = "Arngrim Guards";  // The Army name of the units assigned to guard the Clan Leader.
